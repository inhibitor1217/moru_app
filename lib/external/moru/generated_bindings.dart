...
class NativeLibrary {
  ...
  void bridge_log_write(
    log_write_t f,
    ffi.Pointer<ffi.Void> msg,
    int len,
  ) {
    return _bridge_log_write(
      f,
      msg,
      len,
    );
  ...
  late final _bridge_log_writePtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(log_write_t, ffi.Pointer<ffi.Void>,
              ffi.Int)>>('bridge_log_write');
  late final _bridge_log_write = _bridge_log_writePtr
      .asFunction<void Function(log_write_t, ffi.Pointer<ffi.Void>, int)>();
  ...
  void moru_register_logger(
    log_write_t fn,
  ) {
    return _moru_register_logger(
      fn,
    );
  }

  late final _moru_register_loggerPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(log_write_t)>>(
...
typedef log_write_tFunction = ffi.Void Function(
    ffi.Pointer<ffi.Void> msg, ffi.Int len);
